...
function Contador(props) {
    ...
    return (
        <div className="flex flex-col items-center space-y-4">
            ...
            <button onClick={confirmar} className="px-4 py-2 text-white bg-gray-800 hover:bg-gray-900 rounded-lg shadow-md transition duration-300 ease-in-out">Confirmar Cantidad</button>
        </div>
    )
}
